...
import { Search, Calendar, User, Clock, Plus, BookOpen, Loader2 } from 'lucide-react'
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-white py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 text-lg">Discover delicious recipes, cooking tips, and culinary stories from our community</p>
        </div>
        ...
        {user && (
          <div className="mb-8">
            <Link to="/blogs/write">
              <Button className="bg-green-600 hover:bg-green-700 text-white rounded-2xl px-6 py-3 font-semibold shadow-lg">
            ...
            {blogs.length > 0 ? (
              ...
              <div className="text-center py-20">
                ...
                <p className="text-gray-500 mb-6">
                  {searchQuery ? 'Try adjusting your search terms' : 'Be the first to share a culinary story!'}
                </p>
                {user && !searchQuery && (
                  <Link to="/blogs/write">
